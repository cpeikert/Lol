...
data InstanceDisc = InstanceDisc{challengeID :: !(P'.Int32), instanceID :: !(P'.Int32), params :: !(Challenges.DiscParams),
                                 samples :: !(P'.Seq RLWE.SampleDisc)}
