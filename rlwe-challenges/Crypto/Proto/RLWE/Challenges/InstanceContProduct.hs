...
module Crypto.Proto.RLWE.Challenges.InstanceContProduct (InstanceContProduct(..)) where
import Prelude ((+), (/))
...
import qualified Crypto.Proto.Crypto.Proto.RLWE.SampleContProduct as Crypto.Proto.RLWE (SampleContProduct)
...
instance P'.Mergeable InstanceContProduct where
  mergeAppend (InstanceContProduct x'1 x'2 x'3 x'4) (InstanceContProduct y'1 y'2 y'3 y'4)
   = InstanceContProduct (P'.mergeAppend x'1 y'1) (P'.mergeAppend x'2 y'2) (P'.mergeAppend x'3 y'3) (P'.mergeAppend x'4 y'4)

instance P'.Default InstanceContProduct where
  defaultValue = InstanceContProduct P'.defaultValue P'.defaultValue P'.defaultValue P'.defaultValue

instance P'.Wire InstanceContProduct where
  wireSize ft' self'@(InstanceContProduct x'1 x'2 x'3 x'4)
   = case ft' of
       10 -> calc'Size
  ...
  wirePut ft' self'@(InstanceContProduct x'1 x'2 x'3 x'4)
   = case ft' of
       10 -> put'Fields
       11 -> do
