...
import qualified Crypto.Proto.SHEHint.TunnelHint as SHEHint (TunnelHint)

data TunnelHintChain = TunnelHintChain{hints :: !(P'.Seq SHEHint.TunnelHint)}
