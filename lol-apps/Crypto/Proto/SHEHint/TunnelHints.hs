...
import qualified Crypto.Proto.SHEHint.LinearRq as SHEHint (LinearRq)

data TunnelHints = TunnelHints{coeffs :: !(SHEHint.LinearRq), hint :: !(P'.Seq SHEHint.KSLinearHint), p :: !(P'.Word64),
                               gad :: !(P'.Utf8)}
