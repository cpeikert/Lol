...
module Crypto.Proto.SHEHint.RqPolynomial (RqPolynomial(..)) where
import Prelude ((+), (/))
...
import qualified Crypto.Proto.RLWE.RqProduct as RLWE (RqProduct)

data RqPolynomial = RqPolynomial{coeffs :: !(P'.Seq RLWE.RqProduct)}
