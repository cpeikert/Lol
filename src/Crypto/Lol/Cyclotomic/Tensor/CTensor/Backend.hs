{-# LANGUAGE ConstraintKinds, FlexibleContexts, FlexibleInstances, MultiParamTypeClasses, 
             NoImplicitPrelude, PolyKinds, RankNTypes, RebindableSyntax, ScopedTypeVariables, 
...
-- EAC: the Dispatch r constraint is imperative, otherwise GHC uses the generic instance for RingProduct
withBasicArgs :: forall m r . (Fact m, Storable r, Dispatch r) 
