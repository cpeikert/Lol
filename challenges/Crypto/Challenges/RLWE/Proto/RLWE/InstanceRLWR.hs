...
data InstanceRLWR = InstanceRLWR{challengeID :: !(P'.Int32), index :: !(P'.Int32), m :: !(P'.Int32), q :: !(P'.Int64),
...
instance P'.TextMsg InstanceRLWR where
  ...
  textGet
   = do
       mods <- P'.sepEndBy (P'.choice [parse'challengeID, parse'index, parse'm, parse'q, parse'p, parse'samples]) P'.spaces
