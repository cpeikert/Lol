...
module Crypto.Challenges.RLWE.Proto.RLWE.RLWESampleDisc (RLWESampleDisc(..)) where
import Prelude ((+), (/))
...
data RLWESampleDisc = RLWESampleDisc{a :: !(Lol.Rq), b :: !(Lol.Rq)}
                    deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data, Prelude'.Generic)

instance P'.Mergeable RLWESampleDisc where
  mergeAppend (RLWESampleDisc x'1 x'2) (RLWESampleDisc y'1 y'2) = RLWESampleDisc (P'.mergeAppend x'1 y'1) (P'.mergeAppend x'2 y'2)

instance P'.Default RLWESampleDisc where
  defaultValue = RLWESampleDisc P'.defaultValue P'.defaultValue

instance P'.Wire RLWESampleDisc where
  wireSize ft' self'@(RLWESampleDisc x'1 x'2)
   = case ft' of
       10 -> calc'Size
  ...
  wirePut ft' self'@(RLWESampleDisc x'1 x'2)
   = case ft' of
       10 -> put'Fields
       11 -> do
