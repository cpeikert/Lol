...
module Crypto.Challenges.RLWE.Proto.RLWE.RLWEInstanceDisc (RLWEInstanceDisc(..)) where
import Prelude ((+), (/))
...
import qualified Crypto.Challenges.RLWE.Proto.RLWE.RLWESampleDisc as RLWE (RLWESampleDisc)
