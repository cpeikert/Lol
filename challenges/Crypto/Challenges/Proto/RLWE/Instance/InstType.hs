...
module Crypto.Challenges.Proto.RLWE.Instance.InstType where
import Prelude ((+), (/))
...
import qualified Crypto.Challenges.Proto.RLWE.RLWEInstanceCont as RLWE (RLWEInstanceCont)
import qualified Crypto.Challenges.Proto.RLWE.RLWEInstanceDisc as RLWE (RLWEInstanceDisc)
import qualified Crypto.Challenges.Proto.RLWE.RLWRInstance as RLWE (RLWRInstance)
