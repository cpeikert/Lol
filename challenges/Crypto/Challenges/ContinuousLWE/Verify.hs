...
checkInstance :: (CheckInst t m z zq rq)
  => LWESecret t m z -> RLWEInstanceCont (LiftOf rq) t m zq rq -> Bool
checkInstance (LWESecret _ s) (RLWEInstanceCont _ _ bound samples) = all (checkSample bound s) samples
