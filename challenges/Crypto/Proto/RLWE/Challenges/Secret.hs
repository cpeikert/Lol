...
import qualified Crypto.Proto.RLWE.Challenges.DRBGSeed as Challenges (DRBGSeed)
...
data Secret = Secret{challengeID :: !(P'.Int32), instanceID :: !(P'.Int32), m :: !(P'.Int32), q :: !(P'.Int64),
                     seed :: !(Challenges.DRBGSeed), s :: !(RLWE.Rq)}
    ...
    where
        update'Self wire'Tag old'Self
         = case wire'Tag of
             ...
             42 -> Prelude'.fmap (\ !new'Field -> old'Self{seed = P'.mergeAppend (seed old'Self) (new'Field)}) (P'.wireGet 11)
