...
module Crypto.Proto.RLWE.LinearRq (LinearRq(..)) where
import Prelude ((+), (/))
...
data LinearRq = LinearRq{e :: !(P'.Word32), r :: !(P'.Word32), coeffs :: !(P'.Seq RLWE.RqProduct)}
