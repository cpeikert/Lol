...
import qualified Crypto.Proto.RLWE.KqProduct as RLWE (KqProduct)
import qualified Crypto.Proto.RLWE.RqProduct as RLWE (RqProduct)

data SampleCont = SampleCont{a :: !(RLWE.RqProduct), b :: !(RLWE.KqProduct)}
