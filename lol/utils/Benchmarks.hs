...
data Opts = Opts {verb :: Verb, benches :: [String], colWidth :: Int, testNameWidth :: Int}

defaultWidthOpts :: Verb -> [String] -> Opts
defaultWidthOpts verb benches = Opts {colWidth = 15, testNameWidth=40, ..}
